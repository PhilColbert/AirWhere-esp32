...
void MPU9250::GetAccelGyroData(float* pAccelData, float* pGyroData) {
	...
	Serial.print(pAccelData[0]); Serial.print(" ");
	Serial.print(pAccelData[1]); Serial.print(" ");
	Serial.print(pAccelData[2]); Serial.print(" ");
	Serial.print(pGyroData[0]); Serial.print(" ");
	Serial.print(pGyroData[1]); Serial.print(" ");
	Serial.println(pGyroData[2]);*/
...
int MPU9250::CheckID(void) {
	...
	Serial.print("Imu id "); Serial.println(whoami);
	if (whoami == (0x34) || whoami == (0x38)) return 1; else return 0;
...
void MPU9250::CalibrateAccel(){
	uint8_t buf[6];
	int16_t ax,ay,az,ax0g=0,ay0g=0;
	int16_t az1g = 0;
