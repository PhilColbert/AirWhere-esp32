...
#define HTTP_MAX_DATA_WAIT 2000 //ms to wait for the client to send the request
#define HTTP_MAX_POST_WAIT 2000 //ms to wait for POST data to arrive
#define HTTP_MAX_SEND_WAIT 6000 //ms to wait for data chunk to be ACKed
#define HTTP_MAX_CLOSE_WAIT 3000 //ms to wait for the client to close the connection
