...
public:
	...
	/* device -> air */
	//virtual void ogn_broadcast_successful();
	virtual bool is_ogn_broadcast_ready(int num_neighbors) = 0;
	virtual void ogn_broadcast_successful() = 0;

	virtual float get_speed()= 0;
	virtual float get_heading()= 0;
	virtual float get_climb()= 0;
	virtual float get_turnrate()= 0;
	virtual float get_altitude()= 0;
	virtual float get_lat_sign_negative()= 0;
	virtual float get_lat_deg()= 0;
	virtual float get_lat_min()= 0;
	virtual float get_lat_min_frac()= 0;
	virtual float get_lon_sign_negative()= 0;
	virtual float get_lon_deg()= 0;
	virtual float get_lon_min()= 0;
	virtual float get_lon_min_frac()= 0;
...
private:
	...
	static uint8_t StartRFchipFSK(void);
