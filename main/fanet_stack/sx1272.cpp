...
bool Sx1272::begin(void)
{
	...
	//SX1272_SPI.begin(25,4,16,-1);
	//SX1272_SPI.begin(25,16,4,-1);
...
void Sx1272::writeRegister(byte address, byte data)
{
	...
	//Serial.print(F("## Point WR2 : "));             // ********** CRASH HERE.
...
void IRAM_ATTR Sx1272::sx1272_irq(void)
{
	#if (SX1272_debug_mode > 0)
...
//	Serial.println("RECEIVED PACKET");
	...
	//Serial.println("LORA_STANDBY_MODE");
	//Serial.println(LORA_STANDBY_MODE);
...
//static
void IRAM_ATTR Sx1272::sx_irq_wrapper(void)
{
	sx1272.sx1272_irq();
}
...
void Sx1272::handle_irq(void)
{
     if (receiveIRQ)
     {
    		if (debug_level>0)
    		{
    			Serial.println("*******************************Sx1272 received packet");
    		}
